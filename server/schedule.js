...
const cody10RankTime = '* * * * * 0-6';
const cody20RankTime = '* * * * * 0-6';
const cody30RankTime = '* * * * * 0-6';
const cody40RankTime = '* * * * * 0-6';
const shopRankTime = '* * * * * 0-6';
...
const options = [
	...
	{ method:'GET',uri:'http://apis.skplanetx.com/weather/current/hourly?version='+version+'&lon='+126.585633+'&stnid='+stnid+'&lat='+34.579082+Appkey },
	{ method:'GET',uri:'http://apis.skplanetx.com/weather/current/hourly?version='+version+'&lon='+127.654529+'&stnid='+stnid+'&lat='+34.746086+Appkey }
...
const weatherdata = [
    ...
    'south-Jeju',"north-Jeonnam","south-Jeonnam"
]; 

var weatherTime = '00 14 09 * * 0-6'
var weatherData = {};
var city

function weather(){
	schedule.scheduleJob(weatherTime,async function(){
